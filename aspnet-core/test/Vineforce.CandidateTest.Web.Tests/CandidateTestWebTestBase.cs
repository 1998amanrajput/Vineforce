...
{
    public abstract class CandidateTestWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CandidateTestWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CandidateTestWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CandidateTestDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CandidateTestDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CandidateTestDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CandidateTestDbContext, Task<T>> func)
        {
            T result;
